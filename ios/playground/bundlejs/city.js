...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/chenyilong/Documents/Git/Weex/hello-weex-vue2/examples/city.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-3c73351c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(12)(IteratorPrototype, __webpack_require__(25)('iterator'), function () { return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  data: {
	    rows: [],
	    datas: [[{ name: "San Francisco" }, { name: "New York" }, { name: "Seattle" }, { name: "Chicago" }, { name: "Los Angeles" }, { name: "Boston" }, { name: "Washington" }, { name: "San Diego" }, { name: "San Jose" }, { name: "Philadelphia" }], [{ name: "London" }, { name: "Cambridge" }, { name: "Manchester" }, { name: "Edinburgh" }, { name: "Bristol" }, { name: "Birmingham" }, { name: "Glasgow" }, { name: "Oxford" }, { name: "Newcastle" }, { name: "Leeds" }], [{ name: "Berlin" }, { name: "Munich" }, { name: "Hamburg" }, { name: "Cologne" }, { name: "Stuttgart" }, { name: "Dresden" }, { name: "Leipzig" }], [{ name: "beijing" }, { name: "shanghai" }, { name: "shenzhen" }, { name: "hangzhou" }, { name: "guangzhou" }, { name: "chengdu" }, { name: "nanjing" }, { name: "wuhan" }, { name: "suzhou" }, { name: "xiamen" }, { name: "tianjin" }, { name: "chongqing" }, { name: "changsha" }], [{ name: "Toronto" }, { name: "Vancouver" }, { name: "Montreal" }, { name: "ottawa" }, { name: "Calgary" }, { name: "Quebec" }], [{ name: "Chennai" }, { name: "Pune" }, { name: "Hyderabad" }, { name: "Mumbai" }, { name: "New Delhi" }, { name: "Noida" }, { name: "Ahmedabad" }, { name: "Gurgaon" }, { name: "Kolkata" }], [{ name: "paris" }, { name: "Lyon" }, { name: "Toulouse" }, { name: "Nantes" }], [{ name: "sydney" }, { name: "Melbourne" }, { name: "Brisbane" }, { name: "Perth" }], [{ name: "Tokyo" }, { name: "Moscow" }, { name: "Singapore" }, { name: "Seoul" }]]
	  }
	};
