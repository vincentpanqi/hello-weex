...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/chenyilong/Documents/Git/Weex/hello-weex-vue2/examples/country.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-13ad2442"
	...
	module.exports = {
	  ...
	  methods: {
	    ...
	    onclickcell: function onclickcell(e) {
	      ...
	      if (index === this.rows.length - 1) {} else {
	  ...
	  data: {
	    baseURL: '',
	    rows: [{ name: 'USA' }, { name: 'UK' }, { name: 'Germany' }, { name: 'China' }, { name: 'Canada' }, { name: 'India' }, { name: 'France' }, { name: 'Australia' }, { name: 'Other' }]
	  }
	};
