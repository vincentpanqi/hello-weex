...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/chenyilong/Documents/Git/Weex/hello-weex-vue2/examples/user-rank.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5f702a12"
	...
	module.exports = {
	  ...
	  ready: function ready(e) {
	    ...
	    storage.getItem('language', function (e) {
	      utils.weexLog('get foqo result:' + (0, _stringify2.default)(e));
	  ...
	  methods: {
	    onclickcity: function onclickcity(e) {
	      this.onclicksegment(1);
	    },
	    onclickcountry: function onclickcountry(e) {
	      this.onclicksegment(2);
	    },
	    onclickworld: function onclickworld(e) {
	    ...
	    onclicksegment: function onclicksegment(index) {
	      var vm = this;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    staticClass: ["segment-control"]
	  }, [_c('text', {
	    staticClass: ["select-city"],
	    attrs: {
	      "onclick": "onclickLeftItem"
	    }
	  }, [_vm._v("city")]), _c('text', {
	    staticClass: ["segment-item-city"],
	    attrs: {
	      "id": "city",
	      "onclick": "onclickcity"
	    }
	  }, [_vm._v(_vm._s(_vm.currentCity))]), _c('text', {
	    staticClass: ["segment-item"],
	    attrs: {
	      "id": "country",
	      "onclick": "onclickcountry"
	    }
	  }, [_vm._v(_vm._s(_vm.currentCountry))]), _c('text', {
	    staticClass: ["segment-item"],
	    attrs: {
	      "id": "world",
	      "onclick": "onclickworld"
	    }
	  }, [_vm._v(_vm._s(_vm.languageText))]), _c('text', {
