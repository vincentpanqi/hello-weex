...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/chenyilong/Documents/Git/Weex/hello-weex-vue2/examples/language.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-06b2dd42"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  data: {
	    rows: [{ name: 'All language' }, { name: 'JavaScript' }, { name: 'Java' }, { name: 'PHP' }, { name: 'Ruby' }, { name: 'Python' }, { name: 'CSS' }, { name: 'C' }, { name: 'CPP' }, { name: 'Objective-C' }, { name: 'Swift' }, { name: 'Shell' }, { name: 'R' }, { name: 'Perl' }, { name: 'Lua' }, { name: 'HTML' }, { name: 'Scala' }, { name: 'Go' }]
	  }
	};
