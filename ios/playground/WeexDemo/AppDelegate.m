...
- (void)initWeexSDK
{
    ...
    [WXSDKEngine registerComponent:@"segmented-control" withClass:NSClassFromString(@"WXSegmentedControlComponent")];
    [WXSDKEngine registerComponent:@"seek-bar" withClass:NSClassFromString(@"WXSeekBarComponent")];
    [WXSDKEngine registerComponent:@"stepper" withClass:NSClassFromString(@"WXStepperComponent")];
    [WXSDKEngine registerComponent:@"search-bar" withClass:NSClassFromString(@"WXSearchBarComponent")];
    [WXSDKEngine registerComponent:@"date-picker" withClass:NSClassFromString(@"WXDatePickerComponent")];
    
    [WXSDKEngine registerModule:@"event" withClass:[WXEventModule class]];
    [WXSDKEngine registerModule:@"actionSheet" withClass:NSClassFromString(@"WXActionSheetModule")];
    [WXSDKEngine registerModule:@"MBProgressHUD" withClass:NSClassFromString(@"WXMBProgressHUDModule")];
    [WXSDKEngine registerModule:@"geolocation" withClass:NSClassFromString(@"WXLocationModule")];

    [WXSDKEngine registerModule:@"vibration" withClass:NSClassFromString(@"WXVibrationModule")];
